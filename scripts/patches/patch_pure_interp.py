...
# Let's also increase sync rate to 20ms (50Hz) to make the interpolation targets even tighter
content = content.replace("}, 33);", "}, 20);")

with open('public/pinball.js', 'w', encoding='utf-8') as f:
    f.write(content)
print("Patched pure interpolation")
